...
% function [cond cut vol inds] = cut_cond(A,set, degrees)
%
% Compute the conductance of the set of nodes `set`.
% A must be the (0,1) adjacency matrix of an unweighted, undirected graph.

assert( nargin > 1, sprintf('Must input a set of nodes as second argument.\n') );
